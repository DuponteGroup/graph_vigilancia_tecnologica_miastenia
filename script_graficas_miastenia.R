...
#eliminamos aquellos datos que no son paises 
palabras_no_deseadas= c("Dermatology")
datos_df$paises=sub("Hong Kong", "China", datos_df$paises) #se sustituyen las entradas de Hong Kong para que se cuenten dentro de China
...
png("/Users/paula/Documents/Duponte/graficas_r/miastenia_grafo_scopus.png", width = 3000, height = 2500, res = 300)  # Ajusta width, height y res según tus necesidades
...
png("/Users/paula/Documents/Duponte/graficas_r/miastenia_produccion_paises.png", width = 2500, height = 2500, res = 300)  # Ajusta width, height y res según tus necesidades
df_summary %>% 
  #filter(Production > 1) %>% 
